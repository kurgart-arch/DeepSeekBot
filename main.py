...
class ArchitectBot:
    ...
    async def start_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        await update.message.reply_text(
            ...
            "Просто пиши мне в личку — я отвечу на всё. В группах обращайся ко мне просто наставник .\n\n"
            "Готов начать путь? Отправь мне своё первое сообщение, опиши ситуацию подробно и что сейчас ощущаешь."
        )
...
• Я помню последние 7 сообщений в каждом чате, чтобы видеть контекст.
